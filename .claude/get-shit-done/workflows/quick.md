...
```bash
INIT=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" init quick "$DESCRIPTION")
...
AGENT_SKILLS_EXECUTOR=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-executor 2>/dev/null)
...
AGENT_SKILLS_VERIFIER=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-verifier 2>/dev/null)
```
...
node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(quick-${quick_id}): ${DESCRIPTION}" --files ${file_list}
```
