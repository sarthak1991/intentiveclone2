...
```bash
PHASE_INFO=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
