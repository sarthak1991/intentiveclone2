...
- **Global scope**: `/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/notes/`)
...
2. Glob `/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/notes/` — works in any directory
