...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode
                  → checks /Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/get-shit-done
                  → writes to /Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/sarthakbatra/Documents/new_dev/intentiveclone2/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
